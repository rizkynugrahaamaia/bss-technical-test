...
import { ArrowLeft, Calendar, Tag } from "lucide-react" // Ikon standar lucide
...
export default function ProductDetailPage() {
  ...
  // Ambil data menggunakan hook yang sudah ada
  ...
  return (
    <div className="container mx-auto p-8 max-w-4xl">
      {/* Tombol Back di luar Card agar navigasi mudah */}
      <Button 
        variant="ghost" 
